...
public class BallooniesSwapAndPopWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BallooniesSwapAndPopWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BallooniesSwapAndPopWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BallooniesSwapAndPopWLAIW/InitOutcome.xml").getDocumentElement();
